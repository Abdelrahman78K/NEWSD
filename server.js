...
client.on('message', message=> {
    ...
    {
    message.reply("**لا تمنشن يا سافل**")
    }
});
...
client.on('message',  (message) => {
  ...
  client.on('message', msg => {  
    if (msg.content === 'دخول') {  
      msg.reply('**:white_check_mark: تم تسجيل دخولك بنجاح**');  
    }
  });
  client.on('message', msg => {  
...
client.on('message', msg => {  
    if (msg.content === 'تسجيل خروج') {  
      msg.reply('**:white_check_mark: تم تسجيل خروجك بنجاح**');  
    }
  });
client.on('message', msg => {  
    if (msg.content === 'خروج') {  
...
client.on('message', message => {
        ...
        var args = message.content.split(" ").slice(1);
    if(message.content.startsWith('هح')) {
        if(!message.channel.guild) return message.reply('** This command only for servers **');
         var cat = new Discord.RichEmbed()
  .setTitle(`:hammer_pick: حالة السيرفر Online :hammer_pick:

- Name:  اكس  لايف -

-[iP : cfx.re/join/gabppo]

-[ OR Press : F8 : أو قم بالضغط 

-connect cfx.re/join/gabppo

عند مواجهتك أي مشكلة بالدخول

:loud_sound:  |الدعم الفني بخدمتك 24 ساعة| :loud_sound: `)
            .setColor('#D4AF37')
   .setFooter(`X LIFE.Bot`)
message.channel.sendEmbed(cat);
...
message.channel.sendEmbed(cat);
    ...
    if(message.content.includes('connect')) {
        ...
        .setTitle('❌ | تمت معاقبتك')
        .setAuthor(message.author.username, message.author.avatarURL)
        .addField(`** لقد قمت بمخالفة قوانين السيرفر من خلال نشر ايبي سيرفر  **` , `**ملاحظة  : إن كآن هذآ الاسكات عن طريق الخطأ الرجاء التوجه والتكلم مع الادآرة**`)
        .setColor('#D4AF37')
        .setThumbnail(message.author.avatarURL)
        .setFooter(`${message.guild.name} Server`, message.guild.iconURL)
	...
	client.on('message', message => {
    if(message.content.includes('cfx')) {
        message.delete();
        message.guild.member(message.author).addRole(message.guild.roles.find(r => r.name === 'Muted'));
        let embedP = new Discord.RichEmbed()
        .setTitle('❌ | تمت معاقبتك')
	...
	client.on('message', message => {
    if(message.content.includes('F8')) {
        message.delete();
        message.guild.member(message.author).addRole(message.guild.roles.find(r => r.name === 'Muted'));
        let embedP = new Discord.RichEmbed()
        .setTitle('❌ | تمت معاقبتك')
...
client.on('message', message => {
    ...
    if(message.content.includes('كلب')){
      ...
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
        color: 0x06DF00,
        description: "مَّاش يَلْفِظُ مِن قَوْلٍ إِلَّا لَدَيْهِ رَقِيبٌ عَتِيدٌ ",
        footer: {
        }
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('ابو')){
        message.delete()
        message.guild.member(message.author).addRole(message.guild.roles.find(r => r.name === 'Muted'));
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('خخخ')){
        message.delete()
        message.guild.member(message.author).addRole(message.guild.roles.find(r => r.name === 'Muted'));
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
...
client.on('message', message => {
    var args = message.content.split(/[ ]+/)
    if(message.content.includes('زرقه')){
        message.delete()
        message.guild.member(message.author).addRole(message.guild.roles.find(r => r.name === 'Muted'));
      message.channel.sendMessage("", {embed: {
        title: "لا تسب",
...
if(message.content.startsWith(prefix + "Owner")) {
  ...
  if(message.author.id !== '639583370405347345') return message.channel.send('❎ » انت لست صاحب البوت');
...
const antiSpam = new AntiSpam({
    ...
    maxInterval: 8, // Amount of time (in milliseconds) in which messages are considered spam.
...
client.login('NzQwMjUzMTQ0NTAzNTUwMDM2.XymUdg.f3KP2aTi6tqUubb--k5ZNDZvxwQ');
